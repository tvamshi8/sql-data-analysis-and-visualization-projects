# SQL Data Analysis and Data Visualization Projects
Compilation of SQL, Tableau, and PySpark data analysis projects and challenges focused on developing and maintaining technical proficiency in data analytics.
...
## [Company Employees - SQL and Tableau Visualization Project](https://github.com/ptyadana/MySQL-Tableau-for-Data-Analytics-and-Business-Intelligence)
MySQL and Tableau integration project for analyzing employee data and visualizing the findings across the departments for management including
...
## [Parch and Posey - Data Analysis Project](https://github.com/ptyadana/SQL-for-Data-Analysis-Parch-and-Posey)
PostgreSQL project for helping fictional company called Parch and Posey for 
+ managing the Orders, 
...
## [Restaurant and Library - Information and Patrons Project](SQL%20Code%20Challenges%20-%20Lynda)
SQLite project for 
...
MySQL project for analyzing [California population projection data](https://data.ca.gov/dataset/)
+ getting population data and loading for data analysis
+ finding out male and female populations per county for 2014
...
+ initial cleaning for education data
+ finding the percentage of education attainment for each category across different age group
...
## [UK Road Safety Accidents 2015 Project](Database%20Clinics%20-%20MySQL/02.UK%20Road%20Safty%20Accidents%202015)
MySQL and python project for analyzing [UK road safety data](https://data.gov.uk/dataset/cb7ae6f0-4be6-4935-9277-47e5ce24a11f/road-safety-data), accidents and severity level
+ finding out what is median severity value of accidents caused by various Motorcycle
...
+ calculating performance different query types such as SELECT, INSERT, UPDATE, DELETE
...
# Tableau
+ [LinkedIn Profile](https://www.linkedin.com/in/vamshi-tummala-995948vt/)
...
+ challenges your SQL knowledge with those SQL questions
...
+ challenges your knowledge with those SQL questions
...
## [Complete SQL and Databases - ZTM](Complete%20SQL%20%26%20Databases%20-%20ZTM)
...
# Maintainer
Vamshi Tummala is a Business Analyst with over a year of experience transforming operational data, business requirements, and stakeholder feedback into reporting solutions and measurable business outcomes. Currently pursuing a Master's degree in Data Science, Vamshi specializes in using SQL, Python (Pandas, NumPy), and Power BI to analyze performance trends and strengthen KPI visibility.
